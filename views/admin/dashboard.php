                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="dashboard_graph">
                        ...
                        <div class="row x_title">
                            <div class="col-md-6">
                                <h3>BPN <small>Graph title sub-title</small></h3>
                            </div>
                            <div class="col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="tile_info">
                                            <tr>
                                                <td>
                                                    <p><i class="fa fa-square blue"></i>ANC </p>
                                                </td>
                                                <td>30%</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p><i class="fa fa-square green"></i>IMUN </p>
                                                </td>
                                                <td>10%</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p><i class="fa fa-square purple"></i>FP </p>
                                                </td>
                                                <td>20%</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p><i class="fa fa-square aero"></i>cs </p>
                                                </td>
                                                <td>15%</td>
                                            </tr>
                                            <tr>
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>active weather / <small>Sessions</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                        </li>
                                        <li class="dropdown">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="weather-text">
                                                <h2>KAJIADO <br><i>Partly Cloudy Day</i></h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
