...
CREATE TABLE `live_events` (
  `id` int(11) NOT NULL,
  `childsname` varchar(255) NOT NULL(30) NOT NULL,
...
INSERT INTO `live_events` (`id`, `childsname`, `event_date`, `event_time`, `description`, `status`, `insert_by`, `insert_date`, `update_by`, `update_date`) VALUES
...
(5, 'Outgoing', '2017-05-25', '12:59:00', 'gjhygjhjhhgjhjh', 1, 'admin', '2017-05-24 04:04:43', '', NULL);
...
CREATE TABLE `notices` (
  `id` int(11) NOT NULL,
  `childsname` varchar(30) NOT NULL,
